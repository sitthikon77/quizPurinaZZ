...
function showQuetions(index) {
  ...
  let que_tag =
    ...
    "</span>";
  let option_tag =
    `<div class="option" style="background-color: #EC7A34;" data-questionid="${questions[index].question_id}" data-ans="1"><span>` +
    questions[index].options[0] +
    "</span></div>" +
    `<div class="option" style="background-color: #59B4AE;" data-questionid="${questions[index].question_id}" data-ans="2"><span>` +
    questions[index].options[1] +
    "</span></div>" +
    `<div class="option" style="background-color: #F3AAB6;" data-questionid="${questions[index].question_id}" data-ans="3"><span>` +
    questions[index].options[2] +
    "</span></div>" +
    `<div class="option" style="background-color: #75B44D;" data-questionid="${questions[index].question_id}" data-ans="4"><span>` +
